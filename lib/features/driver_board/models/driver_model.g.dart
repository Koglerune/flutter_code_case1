...
Driver _driverDeserialize(
  ...
  object.status =
      _DriverstatusValueEnumMap[reader.readByteOrNull(offsets[2])] ??
          DriverStatus.idle;
  return object;
}
...
P _driverDeserializeProp<P>(
  ...
  switch (propertyId) {
    ...
    case 2:
      return (_DriverstatusValueEnumMap[reader.readByteOrNull(offset)] ??
          DriverStatus.idle) as P;
    default:
...
const _DriverstatusValueEnumMap = {
  0: DriverStatus.idle,
  1: DriverStatus.waitingForLoad,
  2: DriverStatus.onRoute,
};
...
extension DriverQueryFilter on QueryBuilder<Driver, Driver, QFilterCondition> {
  ...
  QueryBuilder<Driver, Driver, QAfterFilterCondition> lastUpdatedEqualTo(
      DateTime value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
  ...
  QueryBuilder<Driver, Driver, QAfterFilterCondition> lastUpdatedGreaterThan(
    DateTime value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Driver, Driver, QAfterFilterCondition> lastUpdatedLessThan(
    DateTime value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Driver, Driver, QAfterFilterCondition> lastUpdatedBetween(
    DateTime lower,
    DateTime upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension DriverQuerySortBy on QueryBuilder<Driver, Driver, QSortBy> {
  QueryBuilder<Driver, Driver, QAfterSortBy> sortByLastUpdated() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'lastUpdated', Sort.asc);
    });
  }

  QueryBuilder<Driver, Driver, QAfterSortBy> sortByLastUpdatedDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension DriverQuerySortThenBy on QueryBuilder<Driver, Driver, QSortThenBy> {
  ...
  QueryBuilder<Driver, Driver, QAfterSortBy> thenByLastUpdated() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'lastUpdated', Sort.asc);
    });
  }

  QueryBuilder<Driver, Driver, QAfterSortBy> thenByLastUpdatedDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'lastUpdated', Sort.desc);
    });
  }
...
extension DriverQueryWhereDistinct on QueryBuilder<Driver, Driver, QDistinct> {
  QueryBuilder<Driver, Driver, QDistinct> distinctByLastUpdated() {
    return QueryBuilder.apply(this, (query) {
...
extension DriverQueryProperty on QueryBuilder<Driver, Driver, QQueryProperty> {
  ...
  QueryBuilder<Driver, DateTime, QQueryOperations> lastUpdatedProperty() {
    return QueryBuilder.apply(this, (query) {
